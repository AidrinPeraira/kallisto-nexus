-- CreateEnum
CREATE TYPE "UserRole" AS ENUM ('owner', 'sp_organization', 'sp_professional', 'contractor', 'labourer', 'admin');

-- CreateEnum
CREATE TYPE "UserStatus" AS ENUM ('active', 'suspended', 'deleted');

-- CreateSequence (must exist before the app_user table that uses it as a DEFAULT)
